...
class Golpe_martillo(object):
	...
	def __init__(self):
		"""Metodo constructor de la clase. Crea la instancia de la clase. Contiene los atributos nombre, descripcion, autor """
                ...
                self.descripcion="Golpe de puÃÂ±o ÃÂ¡gil y poderoso"
	...
	"""Modela la habilidad. Posee los metodos: __init__, obtener_costos, obtener_consecuencias"""
        def __init__(self):
	        """Metodo constructor de la clase. Crea la instancia de la clase. Contiene los atributos nombre, descripcion, autor """
                ...
                self.descripcion="Utilizado por aquellas criaturas con un grado de inteligencia notable. El Ataque_wachenhausen incorpora a la criatura una determiada inteligencia y la posibilidad de usar un ataque utilizado con la telepatia para daÃÂ±ar al oponente"
                self.autor="Riemer-Masello"
...
class Big_Bang_Attack(object):
	...
	def __init__(self):
		"""Metodo constructor de la clase. Crea la instancia de la clase. Contiene los atributos nombre, descripcion, autor """
	        ...
	        self.descripcion="El ataque Big Bang es un enorme rayo de energia con un increible poder de destrucciÃÂÃÂ³n. La criatura extiende su mano hacia el enemigo y lanza el rayo"
...
class Psicoataque(object):
	...
	def __init__(self):
		"""Metodo constructor de la clase. Crea la instancia de la clase. Contiene los atributos nombre, descripcion, autor """
	        ...
	        self.descripcion="El psicoataque es un ataque que utiliza la fuerza del oponente y la utiliza para causarle daÃÂ±os psicologicos. Este ataque lo podran utilizar aquellas criaturas que posean un elevado grado de inteligencia"
	        self.autor="Masello-Riemer"
	def obtener_costos(self):
		"""Devuelve un diccionario con los valores minimos de caracteristicas y/o indicadores que debe tener la criatura para poder aplicar la habilidad.
                postcondiciones: Devuelve diccionario, cuyas claves contienen atributos de la criatura, y cuyo valor es el minimo necesario de dicho atributo para poder utilizar la habilidad"""
	...
	def elegir_accion(self,origen, destino):
		...
		postcondiciones: devuelve un objeto habilidad, o bien None en el caso de que huya y otro objeto de tipo Criatura"""
			...
			for habilidad in habilidades_criatura.values(): #Itera sobre los objetos habilidades del diccionario
				...
				for clave in costos: #Itera sobre las claves de los costos que son atributos e indicadores mÃÂ­nimos
					if estado_criatura[clave]<costos[clave]: #Verifica que tenga lo requerido para usar dicha habilidad
						posibles_habilidades_a_usar.remove(habilidad.nombre) #Si no alcanza ese atributo, borra esa opciÃÂ³n  
...
def menu():
    ...
    opcion=raw_input("Ingrese su nÃÂºmero de opcion:")
    if opcion=="1":
        jugador1=Jugador()
...
def batalla(jugador1, jugador2):
    """FunciÃÂ³n que recibe dos jugadores, y crea la batalla entre sus monstruos"""
    while True: #Cicla hasta que se desee no jugar más
        ...
        while True: #Cicla hasta que una de las criaturas muera
                ...
                if suma_contex_destreza_criatura_jug1>suma_contex_destreza_criatura_jug2:    #Si la criatura del jugador 1 tiene una contextura y destreza cuya suma es mayor a la de la criatura del jugador 2, comienza el turno la criatura 1
                    ...
                    criatura_elegida_1.aplicar_consecuencias(modificador_origen_1) #Aplica las consecuencias del ataque que realizÃÂ³ el jugador 1, en su monstruo
                    criatura_elegida_1.aplicar_consecuencias(modificador_destino_2) #Aplica las consecuencias del ataque que realizÃÂ³ el jugador 1, en el destino
                ...
                #Si la criatura del jugador dos tiene mayores puntos de contextura y destreza comienza el turno el jugador 2
                    ...
                    criatura_elegida_2.aplicar_consecuencias(modificador_origen_2) #Aplica las consecuencias del ataque que realizÃÂ³ el jugador 2, en su monstruo
                    criatura_elegida_2.aplicar_consecuencias(modificador_destino_1) #Aplica las consecuencias del ataque que realizÃÂ³ el jugador 2, en el destino
